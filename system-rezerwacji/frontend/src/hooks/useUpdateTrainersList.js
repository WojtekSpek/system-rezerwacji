...
export function useUpdateTrainersList(
    ...
    console.log(" useUpdateTrainersList()", {queryKeys, updateValues, optimisticValueSetter});
    const updateMutation = useMutation({
        ...
        onError: (error, values, context) => {
          ...
          const toasterSuffix = [...values?.toasterSuffix, values?.trainerId ];
          console.log("MUTATING SSUFFIX:", toasterSuffix);
        ...
        onSuccess: (data, variables, context) => {
          ...
          const toasterSuffix = [...variables?.toasterSuffix, variables?.trainerId ];
          console.log("MUTATING SSUFFIX:", toasterSuffix);
          const toasterFullName = toasterName + toasterSuffix.join('-');
